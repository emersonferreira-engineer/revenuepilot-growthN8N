...
O workflow n8n que implementa esse contrato — recebe o payload, normaliza os dados, chama o modelo
de IA e valida a resposta antes de devolver o JSON — está versionado em
[`integrations/n8n/revenuepilot-workflow.json`](integrations/n8n/revenuepilot-workflow.json) e pode
ser importado diretamente numa instância n8n. Detalhes em
